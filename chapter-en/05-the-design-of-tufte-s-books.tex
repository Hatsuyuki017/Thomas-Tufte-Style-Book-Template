...
\cmidrule(l){2-5} 
\booktableheadrow
\booktableheadcell{Page content} & \booktableheadcell{\vdqi} & \booktableheadcell{\ei} & \booktableheadcell{\ve} & \booktableheadcell{\be} \\
\midrule
...
\toprule
\booktableheadrow
\booktableheadcell{Feature} & \booktableheadcell{\vdqi} & \booktableheadcell{\ei} & \booktableheadcell{\ve} & \booktableheadcell{\be} \\
\midrule
Author & & & & \\
...
\noindent The body text is set at 10/14, sidenotes and captions at 8/10, the
main heading sizes step upward through 11/15 and 12/16, and the largest book
heads reach 20/30 for chapters and 24/36 for parts.
...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{lcr}
      \toprule
      \booktableheadrow
      \booktableheadcell{Heading} & \booktableheadcell{Style} & \booktableheadcell{Size} \\
      \midrule
...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{lcl}
      \toprule
      \booktableheadrow
      \booktableheadcell{Environment} & \booktableheadcell{Font size} & \booktableheadcell{Notes} \\
      \midrule
