...
\begin{table}
  ...
  \begin{center}
    \begin{tabular}{lr}
      \toprule
      \booktableheadrow
      \booktableheadcell{Heading level} & \booktableheadcell{Value} \\
      \midrule
...
The \TL classes currently only provide three paper sizes: A4,
B5, and US letter.  To specify a different paper size (and/or
